...
class Notification(models.Model):
    ...
    db_index=True,
    help_text="Semantic category/type of this notification (e.g., admission, discharge).",
    )
    ...
    # When the notification was explicitly acknowledged (dismissed/confirmed by a user)
    acknowledged_at = models.DateTimeField(null=True, blank=True)

    # Who acknowledged it (helps audit who clicked/dismissed)
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["category", "patient", "visible_at"]),  # for dedupe checks
    ...
    def __str__(self) -> str:
        return f"[{self.get_level_display()}/{self.get_category_display()}] → {self.recipient} · {self.visible_at:%Y-%m-%d %H:%M}"
    ...
    def push(
        ...
        *,
        ...
        category: str = Category.GENERIC,   # CHANGED from kind
    ) -> "Notification":
        """
        ...
        return cls.objects.create(
            ...
            category=category,              # CHANGED from kind=kind
        )
